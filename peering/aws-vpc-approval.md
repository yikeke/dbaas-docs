...
## 3、Make sure you have enabled private DNS hosted zone support for your VPC.</ColumnTitle>
...
## 4. Associate your VPC with the private hosted zone of TiDB `tidb-phz-id`. </ColumnTitle>
